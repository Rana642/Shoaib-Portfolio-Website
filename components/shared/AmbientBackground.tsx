 ...
 * Citrus leads (brand accent), cobalt and forest appear sparingly —
 * one soft wash of each of the logo's three colors. Pure CSS animation —
 * no JS cost.
 */
export default function AmbientBackground() {
  return (
    <div aria-hidden className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      <div className="ambient-blob-slow absolute -bottom-40 right-1/4 size-[30rem] rounded-full bg-forest/6 blur-3xl" />
    </div>
  );
}
